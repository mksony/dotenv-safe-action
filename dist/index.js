...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            lodash_1.forEach(variables, function (value, key) {
...
const fs = __webpack_require__(747);
const MissingEnvVarsError = __webpack_require__(848);
...
const parseEnv = (envPath, examplePath) => {
    ...
    const envVariablesByName = lodash_1.mapKeys(parsed, (_value, key) => {
        return key.toLowerCase();
    });
    return envVariablesByName;
};
